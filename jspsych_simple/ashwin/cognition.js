...
var practice1 = { 
  ...
  timing_post_trial: 0,
  post_trial_gap:500,
  // timing_response: 1000,//total trial duration needs to changed
  data: {
    task: 'response',
...
var break_block = {
  ...
  stimulus: "<p>Take a break.</p>"+"<P>For Household products, press <STRONG> SPACE </STRONG></p>"+"<p> For edible Food Items or Stationery, <STRONG> DON'T PRESS </STRONG>anything",
  timing_post_trail: 2000
}
